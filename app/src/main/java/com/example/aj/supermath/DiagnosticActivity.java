...
public class DiagnosticActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 10; i++) {
            questions[i].setText(list.get(i).question);
            ...
            choiceItems[(i*4)+generated.get(0)].setText(list.get(i).choice1);
            choiceItems[(i*4)+generated.get(1)].setText(list.get(i).choice2);
            choiceItems[(i*4)+generated.get(2)].setText(list.get(i).choice3);
            choiceItems[(i*4)+generated.get(3)].setText(list.get(i).choice4);
        }
    }
    ...
    public void evaluate (View view) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            if (chosen > 0) {
                ...
                if (clickedButton.getText().toString().equals(list.get(i).answer)) currentScore++;
            }
        }

        BackgroundTask backgroundTask = new BackgroundTask(DiagnosticActivity.this);
        backgroundTask.execute("post_score", "score"+topic_Number+"_pre", String.valueOf(currentScore),
                String.valueOf(topic_Number), "Diagnostic Test");
    }
